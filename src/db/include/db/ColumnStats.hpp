...
private:
 ...
 /**
  * @brief Helper function to get the bucket index for a given value.
  * @param value The value to locate in the histogram.
  * @return The index of the bucket where the value falls.
  */
